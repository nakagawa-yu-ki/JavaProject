...
/*今回制作したjavaのゲームプログラム
 * 
 * A、指定した数字やマークを表示できるプログラム
 * 
 * B、表示が難しい数字（トランプのジャックなど）を表示するプログラム
 * 
 * C、じゃんけんのプログラムをモチーフに、自身が好きなゲームを簡易的に遊べるプログラム
 * の3つを構築してみた。
 * 
 * A、このゲームは入力した数字やマークを表示することができるゲームです。
 * 例えばトランプの♠の1、と入力すれば♠1と表記できます。
 * また、トランプに使われる数字やマーク以外も入力が可能ですので、
 * 気軽に捜査して頂ければと思います。
 * 
 * 次にBのゲームについて
 * このゲームはAのゲームよりよりトランプを意識して制作しました。
 * トランプには1をA、11をJ、という特別な読み方があります。
 * Aのゲームではその仕組みを反映していなかったため、その内容を補填するような
